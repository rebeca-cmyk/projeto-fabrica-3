...
nome_do_mercado = input("nome do mercado: ")
preco_produto1 = float(input("preco do produto: "))
nome_do_mercado2 = input("nome do mercado2: ")
preco_produto2 = float(input("preco do produto: "))
nome_do_mercado3 = input("nome do mercado: ")
...
elif preco_produto2<preco_produto1 and preco_produto2<preco_do_produto3:
